function Fit3140() {
  ...
  Fit3140.prototype.loadMessages = function () {
    ...
    var setMessage = function (data) {
      var val = data.val();
      this.displayMessage(val.totaldata, val.longdata, val.shortdata);
    }.bind(this);
  ...
  Fit3140.prototype.displayMessage = function (totaldata, longdata, shortdata) {
    document.getElementById('total').innerHTML = totaldata;
    document.getElementById('long').innerHTML = longdata;
    if(longdata !== 0){
      var clienttime = new Date().getTime();
      var response = clienttime - longdata;
      document.getElementById('short').innerHTML = response/1000;
    }else{
      document.getElementById('short').innerHTML = 0;
    }
  };
